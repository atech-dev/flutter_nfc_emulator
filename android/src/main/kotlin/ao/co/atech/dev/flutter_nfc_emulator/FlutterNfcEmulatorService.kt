...
class FlutterNfcEmulatorService : HostApduService() {

    private val TAG = "FlutterNfcEmulatorService"
    ...
    private var NDEF_URI = NdefMessage(createTextRecord("en", "NOTHING TO SEND HERE", NDEF_ID))
    ...
    override fun onDeactivated(reason: Int) {
        ...
        val receiver: ResultReceiver? = serviceIntent.getParcelableExtra("listener")
